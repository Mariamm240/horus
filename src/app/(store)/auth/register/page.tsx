      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          <Link href="/" className="inline-flex items-center space-x-2 mb-6">
            ...
            <span className="text-2xl font-bold text-text-base">Horus Optic</span>
          </Link>
        ...
        <Card>
          <CardHeader>
            <CardTitle>Únete a Horus Optic</CardTitle>
            <CardDescription>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex items-start">
                <input
                  ...
                  name="terms"
                  type="checkbox"
                  className="h-4 w-4 text-primary focus:ring-primary border-secondary rounded mt-1"
                  required
                />
              ...
              <div className="flex items-start">
                <input
                  ...
                  className="h-4 w-4 text-primary focus:ring-primary border-secondary rounded mt-1"
                />
                <label htmlFor="newsletter" className="ml-2 block text-sm text-secondary">
            ...
            <div className="mt-6">
              <div className="relative">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-2 bg-white text-secondary">O regístrate con</span>
                </div>
              </div>
        ...
        <div className="text-center space-y-2">
          <p className="text-sm text-secondary">Al crear una cuenta obtienes:</p>
          <ul className="text-xs text-secondary space-y-1">
            <li>• Descuentos exclusivos en suscripciones</li>
            <li>• Seguimiento de pedidos en tiempo real</li>
            <li>• Recordatorios automáticos de reposición</li>
