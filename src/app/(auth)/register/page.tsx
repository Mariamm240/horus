...
export default function RegisterPage() {
  ...
  const onSubmit = async (data: RegisterData) => {
    ...
    try {
      ...
      toast.success("¡Cuenta creada exitosamente! Bienvenido a Horus Optic.")
      ...
      <div className="max-w-md w-full bg-white rounded-2xl shadow-2xl p-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">
            Únete a Horus Optic y cuida tu visión
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="flex items-start">
            ...
            <label htmlFor="terms" className="ml-2 text-sm text-gray-600">
              Acepto los{" "}
              <Link href="/terminos" className="text-primary hover:text-primary/80 font-medium">
                términos de uso
              </Link>{" "}
              y la{" "}
              <Link href="/privacidad" className="text-primary hover:text-primary/80 font-medium">
